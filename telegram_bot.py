...
async def start_message(message: types.Message):
    ...
    await message.answer("Привет! Здесь ты найдешь ближайший прогноз погоды в интересующем тебя городе! Для дополнительной информации воспользуйся командой /help")
...
async def check_message(message: types.Message):
    ...
    if message.text in SET_CITIES:
        ...
        await bot.send_sticker(message.from_user.id,
                               ...
                               reply_markup=kb_help)
        await message.reply("Я вас не понимаю. Воспользуйтесь, пожалуйста, командой /help")
